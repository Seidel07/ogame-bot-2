...
public class ResourcesPage extends AllPages {
    ...
    @FindBy(id = "button10")
    private WebElement metalHideout;
    @FindBy(id = "button11")
    private WebElement crystalHideout;
    @FindBy(id = "button12")
    private WebElement deuteriumHideout;
	...
	buildingList.add(this.metalHideout);
	buildingList.add(this.crystalHideout);
	buildingList.add(this.deuteriumHideout);
	return buildingList;
    }
